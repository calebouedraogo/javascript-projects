...
let dnaTwoUpdate = dnaTwo.replace("GCT", "AGG");
console.log(dnaTwoUpdate);

//2) Look for the gene "CAT" with ``indexOf()``. If found print, "CAT gene found", otherwise print, "CAT gene NOT found".
if (dnaTwoUpdate.indexOf("CAT")) {
...
let separatedDnaTwo = dnaTwo.split("-");
console.log(String(separatedDnaTwo.slice(4, 5)));
